...
INSERT INTO orders(id, store_id, customer_id, total_price, payment_method, order_date, order_location, order_address)
VALUES (1, 4, 1, 500000, 'card', '12-02-2021', 'Almaty', 'Shymkent');

INSERT INTO delivery(id, service_name, delivery_address, price, sending_time, arrival_time, transport_id)
VALUES (1, 'Delivery club', 'Shymkent', 5000, '12-02-2021 10:06:12', '13-02-2021 18:12:56');